...
public class J extends Tetromino {
    public J() {
        ...
        nextOneStates[0] = new TetrominoState(1, 1, 1, 2, 1, 3, 2, 3);
        nextOneStates[1] = new TetrominoState(0, 2, 1, 2, 2, 2, 2, 1);
        nextOneStates[2] = new TetrominoState(1, 1, 2, 1, 2, 2, 2, 3);
        nextOneStates[3] = new TetrominoState(1, 2, 1, 1, 2, 1, 3, 1);
    }
